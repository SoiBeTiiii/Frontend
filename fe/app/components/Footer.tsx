      ...
      <div className={styles.container}>
        ...
        <div className={styles.column}>
          ...
          <div className={styles.payment}>
            ...
            <Image src="/images/amex.png" alt="Amex" width={40} height={25} />
            <Image src="/images/atm.png" alt="ATM" width={40} height={25} />
            <Image src="/images/onepay.png" alt="OnePay" width={40} height={25} />
            <Image src="/images/vnpay.png" alt="VNPAY" width={40} height={25} />
            <Image src="/images/dathongbao.png" alt="Đã Thông Báo" width={120} height={40} />
          </div>
        </div>
      </div>
